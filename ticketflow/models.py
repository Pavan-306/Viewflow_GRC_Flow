...
class FormField(models.Model):
    ...
    choices = models.TextField(blank=True, help_text='For "Drop-down/Radio": comma-separated options')
    ...
    placeholder = models.CharField(max_length=200, blank=True, help_text="Placeholder for inputs", default="")
    default_value = models.CharField(max_length=200, blank=True, help_text="Default text/value", default="")
    min_value = models.IntegerField(null=True, blank=True)
    max_value = models.IntegerField(null=True, blank=True)
    regex = models.CharField(max_length=200, blank=True, help_text="Optional regex validation", default="")
    readonly = models.BooleanField(default=False, help_text="Show as read-only")
    hidden = models.BooleanField(default=False, help_text="Hide field in forms (but store value if present)")
...
class TicketProcess(Process):
    ...
    entry = models.OneToOneField(FormEntry, null=True, blank=True, on_delete=models.SET_NULL, related_name="ticket_process")
